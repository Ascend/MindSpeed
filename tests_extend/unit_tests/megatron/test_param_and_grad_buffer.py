...
def get_model_and_buffers(
    ...
    param_and_grad_buffer = ParamAndGradBuffer(
        ...
        params=params,
        data_parallel_group=Utils.get_data_parallel_group(),
...
class TestParamAndGradBuffer(DistributedTest):
    ...
    def test_bucket_sizes(self, bucket_size: int, use_distributed_optimizer: bool, bias: bool):
    ...
    def test_grad_sync(self, use_distributed_optimizer: bool, overlap_grad_reduce: bool):
        Utils.initialize_model_parallel()
