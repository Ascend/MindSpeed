...
from mindspeed.multi_modal.dist_train.config.dist_train_config import ContextKey
...
def make_whole_config(configs, is_use_send_recv_list: bool = False, model_name="internvl2"):
    """ Get whole dist_train config """
    if configs is None or configs == []:
        return None
    whole_config = {
        CK.IS_USE_SEND_RECV_LIST: is_use_send_recv_list,
