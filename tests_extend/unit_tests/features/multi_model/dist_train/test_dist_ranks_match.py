...
from mindspeed.multi_modal.dist_train.communication import dist_ranks_match as match
...
class TestDistRanksMatchWithDistributed(DistributedTest):
    ...
    def _get_ranks_matrix(start_rank, row_size, col_size, dp_size=1):
        ...
        tp_ranks = [ranks[i * row_size: (i + 1) * row_size] for ranks in tp_ranks for i in range(dp_size)]
