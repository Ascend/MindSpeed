...
class TestNormRecompute(DistributedTest):
    ...
    def norm_recopute(self):
        ...
        out_ref = transformer_block_ref(hidden_states=hidden_states_ref, attention_mask=None)
        out_test = transformer_block_test(hidden_states=hidden_states_test, attention_mask=None)
