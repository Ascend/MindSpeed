    ...
    def get_query_key_value_tensors(
        ...
        *,
        ...
        if self.recompute_up_proj:
            # MLASelfAttention.__init__ initializes this inherited instance attribute.
            self.qkv_up_checkpoint = (  # pylint: disable=attribute-defined-outside-init
    ...
    def forward(
        ...
        *,
        ...
        if self.recompute_up_proj:
            ...
            self.qkv_up_checkpoint = None  # pylint: disable=attribute-defined-outside-init
