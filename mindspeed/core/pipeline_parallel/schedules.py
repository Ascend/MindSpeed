...
def get_forward_backward_func_wrapper(get_forward_backward_func):
    ...
    def wrapper(*args, **kwargs):
        ...
        if (
            ...
            return flexible_schedules.forward_backward_pipelining_with_interleaving_nano_pipe  # pylint: disable=no-member
...
def get_tensor_shapes_wrapper(get_tensor_shapes):
    ...
    def wrapper(*args, **kwargs):
        ...
        if arguments.tp_2d:
            tensor_shapes = [
                [tensor_shape[0] // arguments.tp_x, tensor_shape[1], tensor_shape[2] // arguments.tp_y]
