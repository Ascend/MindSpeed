...
from mindspeed.auto_tuning.module.communication.communication_profile import Mc2ProfileTimeInfo
...
class Mc2CommPerfPredictor(CommPerfPredictor):
    ...
    def get_communication_info_from_profile(
        self, mc2_profile_time_info: Mc2ProfileTimeInfo, hcom_info_tag_id, index
    ):
        mc2_res = hcom_info_tag_id[index][1]
        mat_res = hcom_info_tag_id[index - 1][1]
