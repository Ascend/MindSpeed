...
class DisableGlooGroupFeature(MindSpeedFeature):
    ...
    def register_patches(self, patch_manager, args):
        from mindspeed.core.optimizer.distrib_optimizer import (
        ...
        from mindspeed.core.parallel_state import (
            ...
            get_expert_data_parallel_group_gloo_replace,
            new_group_wrapper,
        )
        ...
        if getattr(args, self.feature_name, None):
            ...
            patch_manager.register_patch(
                'megatron.core.utils.check_param_hashes_across_dp_replicas', check_param_hashes_across_dp_replicas_hccl
            )

            patch_manager.register_patch(
                'megatron.core.parallel_state.get_data_parallel_group_gloo', get_data_parallel_group_gloo_replace
            )
            patch_manager.register_patch(
            ...
            patch_manager.register_patch(
                'megatron.core.parallel_state.get_expert_data_parallel_group_gloo',
                get_expert_data_parallel_group_gloo_replace,
            )
