...
class TP2dFeature(MindSpeedFeature):
    ...
    def register_patches(self, patch_manager, args):
        if getattr(args, self.feature_name, None):
            ...
            patch_manager.register_patch(
                'megatron.core.pipeline_parallel.schedules.get_tensor_shapes', mindspeed_get_tensor_shapes_wrapper
            )

            from mindspeed.core.tensor_parallel.tp_2d.adaptor import (
            ...
            patch_manager.register_patch(
                ...
                mindspeed_transformer_block_forward_wrapper,
            )
            ...
            patch_manager.register_patch(
                'megatron.core.parallel_state.initialize_model_parallel', mindspeed_initialize_model_parallel_wrapper
            )
            ...
            from mindspeed.core.tensor_parallel.tp_2d.adaptor import (
                mindspeed_attention_init,
                mindspeed_self_attention_init_wrapper,
            )

            patch_manager.register_patch(
                'megatron.core.transformer.attention.SelfAttention.__init__', mindspeed_self_attention_init_wrapper
            )
            patch_manager.register_patch(
                'megatron.core.transformer.attention.Attention.__init__', mindspeed_attention_init
            )
            patch_manager.register_patch(
                'megatron.core.transformer.attention.SelfAttention.__init__', mindspeed_self_attention_init_wrapper
            )
