...
def transformer_layer_forward_dense_backward_moe_overlaping(
    ...
    bwd_unperm_a2a_handle = None
    (detached_expert_output_grad,) = run_graph_backward(bwd_layer_graph.unperm1_graph, unperm1_out_grad)
    ...
    detached_perm_a2a_out_grad, perm_prob_a2a_out_grad = run_graph_backward(bwd_layer_graph.perm2_graph, (detached_dispached_input_grad, detached_dispached_input_probs_grad),
...
def transformer_layer_forward_moe_backward_moe_overlaping(
    ...
    bwd_unperm_a2a_handle.wait()
    bwd_unperm_a2a_handle = None
    mlp_graph_grad, = run_graph_backward(bwd_layer_graph.unperm1_graph, unperm1_out_grad)
    if args.moe_zero_memory == 'level0' or should_recompute_activation(bwd_layer_graph.layer.layer_number):
        bwd_layer_graph.act_ckpt_manager.recompute(True)
    unperm1_out_grad.untyped_storage().resize_(0)
    ...
    perm_a2a_graph_grad, perm_prob_a2a_out_grad = run_graph_backward(bwd_layer_graph.perm2_graph, (perm2_graph_grad, detached_dispached_input_probs_grad), keep_graph=True)
