...
class KVAllGatherCPStrategy(BaseCPStrategy):
    ...
    def forward(
        ...
        **kwargs,
        ...
        if qkv_format == 'sbhd':
            query_layer, key_layer, value_layer, n_head = prepare_sbhd_format(query_layer, key_layer, value_layer)
...
class CPStrategyFactory:
    ...
    @staticmethod
    def create_strategy(strategy_type: str, **strategy_params) -> BaseCPStrategy:
