...
def training_log(
    ...
    if writer and (iteration % args.tensorboard_log_interval == 0):
        ...
        if getattr(args, 'log_max_attention_logit', False):
    ...
    if iteration % args.log_interval == 0:
        ...
        if getattr(args, 'log_max_attention_logit', False):
            log_string += ' max attention logit: {:.3f} |'.format(max_attention_logit)
        ...
        if report_memory_flag and learning_rate is not None and learning_rate > 0.0:
