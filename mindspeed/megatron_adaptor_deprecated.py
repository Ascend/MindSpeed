...
def mcore_models_adaptation_l0(aspm):
    ...
    aspm.register_patch(
        ...
        get_gpt_decoder_block_spec_wrapper)
...
def mcore_models_adaptation(aspm, mindspeed_args):
    ...
    if mindspeed_args.recompute_norm:
        ...
        aspm.register_patch(
            ...
            build_norm_recompute_layer_wrapper)
...
def memory_fragmentation_adaptation(aspm, args):
    ...
    if args.adaptive_memory_optimization and not (
            args.adaptive_recompute_enable or args.memory_fragmentation or args.swap_attention or args.smart_swap):
        ...
        aspm.register_patch(
            ...
            setup_adapt_memory_optimizer_wrapper)
...
def deepspeed_moe_adaptation(pm, args):
    ...
    if args.use_pipe_experts:
        ...
        pm.register_patch(
            'megatron.core.distributed.param_and_grad_buffer._ParamAndGradBucketGroup.register_grad_ready',
...
def Megatron_share_expert_test(aspm, mindspeed_args):
    ...
    # Without TE, use ColumnParallelLinear and RowParallelLinear replace
    # TEColumnParallelLinear for Megatron share expert.
