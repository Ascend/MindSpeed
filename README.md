...
更多具体说明请参考：[版本配套表](./docs/zh/release_notes.md#相关产品版本配套说明)。

# 安装

---

MindSpeed Core拉取源码后使用pip命令行安装`pip install -e MindSpeed`，具体请参考 [部署文档](./docs/zh/install_guide.md) 安装 MindSpeed Core 指定分支及其依赖软件。
