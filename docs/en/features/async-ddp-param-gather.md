...
To address this issue, we introduce a parallel execution strategy that overlaps computation and communication using pipelining.
...
<p align="center"> <img src="../figures/async_ddp_param_gather_a_en.png" height="350px" width="880px" style="display:block;"></p>
...
<p align="center"> <img src="../figures/async_ddp_param_gather_b_en.png" height="350px" width="880px" style="display:block;"></p>
...
<p align="center"> <img src="../figures/async_ddp_param_gather_c_en.png" height="350px" width="880px" style="display:block;"></p>
...
1. To enable weight update communication overlap, add the following parameters to the training configuration.

   ```bash
    --overlap-param-gather
    ```

2. Ensure the following two parameters are also enabled.
...
According to actual test data, when training a large language model such as LLAMA2-70B, applying the weight update communication overlap technique improved end-to-end performance by 3.4%.
