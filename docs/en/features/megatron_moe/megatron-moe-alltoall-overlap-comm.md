...
Additionally, the alltoall branch is compatible with Megatron's moe-shared-expert-overlap and, through finer-grained overlapping, achieves further performance improvements over the native solution.
