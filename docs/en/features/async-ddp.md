...
<p align="left"> <img src="../figures/async_ddp_en.png" height="250px" width="680px" style="display:block;"></p>
...
Asynchronous DDP significantly improves resource utilization and training efficiency in large model training by overlapping computation and communication tasks. For the Llama-2-70b model, it achieves an end-to-end performance improvement of approximately 2-3%.
