...
When memory is not fully utilized, enabling the Matmul_Add fused operator will improve model training performance. For the Llama2-7b model, the performance gain is approximately 2%.
