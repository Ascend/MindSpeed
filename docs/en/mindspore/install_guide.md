...
1. Download the MindSpeed source code from the `26.1.0_core_r0.12.1` branch. Pay attention to the letter case in the following commands.
...
```shell
pip uninstall -y mindspeed  # Use lowercase mindspeed
```
