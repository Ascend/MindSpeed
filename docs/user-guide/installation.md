...
| 2.3.0_core_r0.12.1（商用） | Core 0.12.1 | 2.6.0, 2.7.1 | 7.3.0       | 8.5.0 | Python3.10.x               |
...
<table>
  ...
  <tbody>
    <tr>
      <td>昇腾NPU驱动</td>
      <td rowspan="2">《<a href="https://www.hiascend.com/document/detail/zh/canncommercial/850/softwareinst/instg/instg_0008.html?Mode=PmIns&InstallType=local&OS=Debian">安装NPU驱动和固件</a>》</td>
    </tr>
    <tr>
      <td>昇腾NPU固件</td>
    </tr>
    <tr>
      <td>Toolkit（开发套件）</td>
      <td rowspan="3">《<a href="https://www.hiascend.com/document/detail/zh/canncommercial/850/softwareinst/instg/instg_0000.html?Mode=PmIns&InstallType=local&OS=Debian">CANN安装软件</a>》</td>
    </tr>
    <tr>
      <td>ops（算子包）</td>
    </tr>
    ...
    <tr>
      <td>PyTorch</td>
      <td rowspan="3">《<a href="https://www.hiascend.com/document/detail/zh/Pytorch/730/configandinstg/instg/docs/zh/installation_guide/installation_description.md">Ascend Extension for PyTorch 安装说明</a>》</td>
    </tr>
    <tr>
      <td>torch_npu插件</td>
    </tr>
...
### 2. 下载MindSpeed源码2.3.0_core_r0.12.1分支（请注意下列命令的大小写）
