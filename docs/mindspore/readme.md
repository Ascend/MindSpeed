...
### 2. 获取 MindSpore-Core-MS 并指定分支

获取并切换 MindSpeed-Core-MS 版本至 r0.3.0 版本，并安装Python三方依赖库，如下所示：
...
可以参考MindSpeed-Core-MS目录下提供的[一键适配命令脚本](https://gitee.com/ascend/MindSpeed-Core-MS/tree/r0.3.0/#%E4%B8%80%E9%94%AE%E9%80%82%E9%85%8D)，拉取并适配相应版本的MindSpeed、Megatron-LM和MSAdapter。

**若使用MindSpeed-Core-MS目录下的一键适配命令脚本（如[auto_convert_llm.sh](https://gitee.com/ascend/MindSpeed-Core-MS/blob/r0.3.0/auto_convert_llm.sh)）可忽略后面步骤。**
