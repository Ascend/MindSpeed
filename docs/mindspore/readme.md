...
### 2. 获取 [MindSpore-Core-MS](https://gitcode.com/Ascend/MindSpeed-Core-MS/tree/r0.4.0) 代码仓
...
可以参考MindSpeed-Core-MS目录下提供的[一键适配命令脚本](https://gitcode.com/Ascend/MindSpeed-Core-MS/tree/r0.4.0#%E4%B8%80%E9%94%AE%E9%80%82%E9%85%8D)， 拉取并适配相应版本的MindSpeed、Megatron-LM和MSAdapter。

**若使用MindSpeed-Core-MS目录下的一键适配命令脚本（如[auto_convert.sh](https://gitcode.com/Ascend/MindSpeed-Core-MS/blob/r0.4.0/auto_convert.sh)）可忽略后面步骤。**
...
```
具体版本对应关系参考MindSpore-Core-MS下的[一键适配命令脚本](https://gitcode.com/Ascend/MindSpeed-Core-MS/tree/r0.4.0#%E4%B8%80%E9%94%AE%E9%80%82%E9%85%8D)，如[auto_convert.sh](https://gitcode.com/Ascend/MindSpeed-Core-MS/blob/r0.4.0/auto_convert.sh)。
